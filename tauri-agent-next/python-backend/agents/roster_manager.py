...
class AgentRosterManager:
    def __init__(
        ...
        *,
        ...
        self.run_request_queue: Optional["RunRequestQueue"] = None
    ...
    def _instantiate_agent(
        ...
        *,
        ...
        if record.agent_type == "user_proxy":
            if self.run_manager is None or self.run_request_queue is None:
            ...
            return UserProxyAgent(
                ...
                roster_manager=self,
                run_request_queue=self.run_request_queue,
            )
        if record.agent_type == "assistant":
